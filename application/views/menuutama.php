 ...
 <!-- My Fonts -->
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light">
      <div class="container">
        <a class="navbar-brand" href="<?= base_url('menuutama')?>">Diet-in Aja</a>
        ...
        <!-- <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div class="navbar-nav ml-auto">
            ...
            <a class="nav-item nav-link" href="#">Calculator</a>
            <a class="nav-item nav-link" href="#">Myth and Fact</a>
            <a class="nav-item nav-link" href="#">Food Calories</a>
          </div>
        </div> -->
      </div>
    </nav>
    ...
    <div class="jumbotron jumbotron-fluid">
      <div class="container">
        <h1 class="display-4"><span>Hello!</span><br>Welcome to <span>Diet-in Aja</span></h1>
        <a href="<?= base_url('login')?>" class="btn btn-primary tombol"> Get Started</a>
      </div>
    </div>
    <!-- Akhir Jumbotron -->
    ...
    <div class="container">
      ...
      <section class="testimonial">
        ...
        <div class="row justify-content-center">
          ...
          <figure class="figure">
              <img src="assets/img/bagas2.png" class="figure-img img-fluid rounded-circle utama" alt="Testi 1">
            </figure>
            <figure class="figure">
            ...
            <figure class="figure">
              <img src="assets/img/putra2.png" class="figure-img img-fluid rounded-circle utama" alt="Testi 5">
            </figure>
          </div>
        </div>
      </section>
